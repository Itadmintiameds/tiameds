...
const Herosection = () => {
          ...
          <div className="mx-auto max-w-7xl py-32 sm:py-48 lg:py-28">
            <div className="text-center">
              ...
              <h1 className="text-5xl font-bold tracking-tight text-gray-900 sm:text-7xl">
                ...
                <span className="relative inline-block">
                  <span className="relative">
                    ...
                    <span className="absolute bottom-0 left-0 h-1 bg-gradient-to-r from-primary to-secondary w-full" />
                  </span>
                </span>
              ...
              <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-6">
                <div className="relative rounded-lg bg-gradient-to-r from-primary to-secondary px-6 py-3 text-white font-medium shadow-lg">
  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-white">
      <div className="relative isolate px-6 pt-14 lg:px-8 overflow-hidden">
        {/* Animated floating tech elements - now only rendered on client */}
