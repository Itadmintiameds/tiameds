...
import { FaFlask, FaPills, FaShoppingCart, FaCalendarAlt, FaMicroscope } from 'react-icons/fa';
  ...
  const solutions = [
    {
      ...
      description: 'End-to-end pharmacy automation and inventory control',
      highlight: '95% accuracy in dispensing'
    },
    {
      icon: <FaMicroscope className="h-8 w-8" />,
      name: 'Lab Automation',
      description: 'Advanced LIMS for diagnostic laboratories',
