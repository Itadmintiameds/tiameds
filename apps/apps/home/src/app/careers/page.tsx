      ...
      <div className="relative isolate px-6 pt-14 lg:px-8 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl py-32 sm:py-48 lg:py-28">
          ...
          >
            ...
            >
              <span className="block">Transform Industries</span>
            ...
            >
              At Tiameds Technology, we're building innovative solutions for enterprises. 
              Join our mission-driven team of innovators creating cutting-edge platforms.
            </motion.p>
