...
// //
// // Response shapes for AdminStatsController (backend: /lab-admin/stats/**),
// // the lab-scoped counterpart to SuperAdminStatsController.
...
// // Tests by category from AdminStatsController
// export interface TestsByCategoryRow {
//     category: string;
//     count: number;       
//     percentage: number;   
...
// // Singular - this lab's revenue only
// export interface RevenueByLab {
//     labId: number;
//     labName: string;
//     revenue: number;
...
// // Singular - this lab's performance
// export interface LabPerformance {
//     labId: number;
//     labName: string;
//     revenue: number;
...
// // Sample Workflow Funnel (derived from multiple endpoints)
// export interface SampleWorkflowFunnel {
//     samplesRegistered: {
//         count: number;
//         percentage: number;
