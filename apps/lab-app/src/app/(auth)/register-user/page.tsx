                    ...
                    >
                      <div className="relative">
                        ...
                        <input
                          ...
                          value={formData[field.name as keyof RegisterData] as string}
                          onChange={handleInputChange}
                          className={`block w-full rounded-lg ${errors[field.name] ? 'border-red-500' : 'border-gray-300'} pl-10 pr-4 py-3 text-gray-700 placeholder-gray-400 focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 hover:shadow-sm border`}
                        />
                      </div>
                      {errors[field.name] && (
