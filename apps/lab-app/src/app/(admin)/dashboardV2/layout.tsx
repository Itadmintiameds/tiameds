...
const navigation: NavigationItem[] = [
  { name: "Dashboard", href: "/dashboardV2", icon: HomeIcon, current: true },
  {
    name: "Lab Management",
    icon: FlaskConical,
    current: false,
  ...
  },
  {
    ...
    current: false,
    children: [
      { name: "Profile", href: "dashboardV2/profile", current: false, icon: UserIcon },
      { name: "Preferences", href: "#", current: false, icon: ClipboardListIcon },
      { name: "Lab", href: "/dashboardV2/lab", current: false, icon: FlaskConical },
    ],
  },
  {
    name: "Profile",
      ...
      <main className={`flex-1 ml-20 transition-all duration-400 ${isOpen ? "ml-64" : "ml-20"}`}>
        ...
        <nav className="flex items-center justify-between py-2 px-6 border-b border-gray-200 bg-white shadow-md rounded">
          ...
          <div className="flex space-x-4 ml-auto">
            ...
            <Link href='/dashboardV2/profile' className="relative flex items-center text-white justify-center w-10 h-10 text-gray-700 bg-indigo-950 rounded-md hover:bg-indigo-900 transition duration-200">
