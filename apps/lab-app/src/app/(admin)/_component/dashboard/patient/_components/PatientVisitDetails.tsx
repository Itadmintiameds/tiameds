...
//                         .map((insurance) => insurance.data);       // Extract the `data` property
...
//                 {/* Patient Details */}
//                 <section className="p-2 bg-gray-100 rounded-md mb-4 lg:col-span-4">
//                     <h1 className="text-sm font-semibold mb-2 text-gray-800">Patient Details</h1>
//                     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 text-xs text-gray-700">
//                         <div className="flex items-center space-x-2">
//                             <FaUser className="text-blue-500 text-xs" />
//                             <span>{patientVisitDetails?.firstName} {patientVisitDetails?.lastName}</span>
//                         </div>
//                         <div className="flex items-center space-x-2">
//                             <FaEnvelope className="text-blue-500 text-xs" />
//                             <span>{patientVisitDetails?.email}</span>
//                         </div>
//                         <div className="flex items-center space-x-2">
//                             <FaTint className="text-blue-500 text-xs" />
//                             <span>{patientVisitDetails?.bloodGroup}</span>
//                         </div>
//                         <div className="flex items-center space-x-2">
//                             <FaCity className="text-blue-500 text-xs" />
//                             <span>{patientVisitDetails?.city}</span>
//                         </div>
//                         <div className="flex items-center space-x-2">
//                             <FaMapMarkerAlt className="text-blue-500 text-xs" />
//                             <span>{patientVisitDetails?.address}</span>
//                         </div>
//                         <div className="flex items-center space-x-2">
//                             <FaBirthdayCake className="text-blue-500 text-xs" />
//                             <span>{calculateAge(patientVisitDetails?.dateOfBirth ?? '')} years</span>
//                         </div>
//                         <div className="flex items-center space-x-2">
//                             <FaPhone className="text-blue-500 text-xs" />
//                             <span>{patientVisitDetails?.phone}</span>
//                         </div>
//                         <div className="flex items-center space-x-2">
//                             <FaMapPin className="text-blue-500 text-xs" />
//                             <span>{patientVisitDetails?.zip}</span>
//                         </div>
//                     </div>
//                 </section>

//                 {/* Insurance Details */}
//                 <section className="p-2 bg-gray-100 rounded-md mb-4 lg:col-span-1">
//                     <h1 className="text-sm font-semibold mb-2 text-gray-800">Insurance Details</h1>
//                     {(insurance ?? []).length > 0 ? (
...
//                 {/* Doctor Details (25%) */}
//                 <section className="col-span-1 p-2 bg-gray-100 rounded-md">
//                     <h1 className="text-sm font-semibold mb-2 text-gray-800">Doctor Details</h1>
//                     <div className="grid grid-cols-1 gap-2 text-xs text-gray-700">
//                         <div className="flex items-center space-x-2">
//                             <FaUserMd className="text-green-500 text-xs" />
...
//                 {/* Visit Details (75%) */}
//                 <section className="col-span-3 p-2 bg-gray-100 rounded-md">
//                     <h1 className="text-sm font-semibold mb-2 text-gray-800">Visit Details</h1>
//                     <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 text-xs text-gray-700">
//                         <div className="flex items-center space-x-2">
//                             <FaNotesMedical className="text-blue-500 text-xs" />
//                             <span>Visit ID: {patientVisitDetails?.visit?.visitId}</span>
//                         </div>
//                         <div className="flex items-center space-x-2">
//                             <FaNotesMedical className="text-blue-500 text-xs" />
//                             <span>Visit Date: {patientVisitDetails?.visit?.visitDate}</span>
//                         </div>
//                         <div className="flex items-center space-x-2">
//                             <FaBirthdayCake className="text-blue-500 text-xs" />
//                             <span>Visit Date: {patientVisitDetails?.visit?.visitDate}</span>
...
//                         <div className="flex items-center space-x-2">
//                             <FaCity className="text-blue-500 text-xs" />
//                             <span>Visit Type: {patientVisitDetails?.visit?.visitType}</span>
//                         </div>
//                         <div className="flex items-center space-x-2">
//                             <FaCity className="text-blue-500 text-xs" />
//                             <span>Visit Status: {patientVisitDetails?.visit?.visitStatus}</span>
//                         </div>
//                         <div className="flex items-center space-x-2">
//                             <FaCity className="text-blue-500 text-xs" />
//                             <span>Total Amount: {patientVisitDetails?.visit?.billing?.totalAmount}</span>
//                         </div>
//                     </div>
//                 </section>
//             </div>

//             <section className="p-4 bg-gray-100 rounded-md my-2">
//                 <h1 className="text-lg font-semibold mb-4 text-gray-800">Tests, Packages, and Billing</h1>
//                 <div className="grid grid-cols-1 lg:grid-cols-10 gap-6">
//                     {/* Left Column: Tests and Packages (30%) */}
//                     <div className="lg:col-span-3 space-y-4">
//                         {/* Tests Section */}
//                         <div className="bg-white p-4 rounded-md shadow-sm">
//                             <h2 className="font-semibold text-gray-800 mb-2">Tests</h2>
...
//                                             <td className="p-2 text-right">₹{test.price}</td>
//                                         </tr>
//                                     ))}
//                                 </tbody>
//                             </table>
...
//                             <h2 className="text-lg font-bold text-gray-900 border-b pb-3 mb-4">Health Packages Bill</h2>
//                             <div className="mb-6">
//                                 <h3 className="text-md font-semibold text-gray-800">Summary</h3>
//                                 <p className="text-sm text-gray-600">
//                                     <span className="font-medium">Patient:</span> John Doe <br />
//                                     <span className="font-medium">Visit Date:</span> 03-Jan-2025
//                                 </p>
//                             </div>
...
//                                             </tr>
//                                             <tr>
//                                                 <td colSpan="4" className="p-3 text-gray-600 text-sm">
//                                                     <ul className="pl-4 list-disc">
//                                                         {pkg.tests.map((test) => (
//                                                             <li key={test.id} className="mb-1">
//                                                                 <span className="font-medium">{test.name}</span>
//                                                                 <span className="text-gray-500"> ({test.category})</span>
//                                                                 <span className="float-right text-gray-700">₹{test.price.toFixed(2)}</span>
//                                                             </li>
//                                                         ))}
//                                                     </ul>
//                                                 </td>
...
//                             <div className="border-t pt-4 text-gray-800 text-sm">
//                                 <div className="flex justify-between mb-2">
//                                     <span className="font-medium">Subtotal:</span>
//                                     <span>₹{healthPackage?.reduce((sum, pkg) => sum + pkg.price, 0).toFixed(2)}</span>
//                                 </div>
//                                 <div className="flex justify-between mb-2">
//                                     <span className="font-medium text-red-600">Total Discount:</span>
//                                     <span className="text-red-600">- ₹{healthPackage?.reduce((sum, pkg) => sum + pkg.discount, 0).toFixed(2)}</span>
//                                 </div>
...
//                     {/* Right Column: Billing Details (70%) */}

//                     <div className="lg:col-span-7 bg-white p-4 rounded-md shadow-sm">
//                         <h2 className="font-semibold text-gray-800 mb-4">Billing Details</h2>
...
//             <section className="p-2 bg-gray-100 rounded-md flex justify-end">
//                 <Button
//                     text='Print'
