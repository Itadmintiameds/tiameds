...
// const PatientVisit = ({ newPatient, handleChange, doctors, insurances }: PatientVisitProps) => {
...
//             ? selectedInsurances.filter(id => id !== insuranceId) // Remove
//             : [...selectedInsurances, insuranceId]; // Add

//         setSelectedInsurances(updatedInsurances);

//         // Update the parent component with the selected insurances
//         handleChange({ target: { name: 'visit.insuranceIds', value: updatedInsurances } });
//     };
