...
// import Table from '@/app/(admin)/_component/patientsData
    ...
    return (
        ...
        ${statuses[key].bgColor} ${activeTab === key ? 'border-2 border-indigo-600' : 'border-transparent'} transition duration-300 border border-gray-200`}
            ...
            {activeTab === 'results' && <ResultsTable />} */}
                        ...
                        {activeTab === 'purchases' && <>hello</>}
                        {activeTab === 'newBill' && <>hello</>}
                        {activeTab === 'patients' && <>hello</>}
                        {activeTab === 'tests' && <>hello</>}
                        {activeTab === 'results' && <>hello</>}
                    </motion.div>
                )}
            </div>
        </div>
