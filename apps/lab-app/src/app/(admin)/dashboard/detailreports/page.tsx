...
const Page = () => {
  ...
  const [graphsDateFilter, setGraphsDateFilter] = useState<DateFilterOption>('today');
  const [graphsCustomStartDate, setGraphsCustomStartDate] = useState<Date | null>(null);
  const [graphsCustomEndDate, setGraphsCustomEndDate] = useState<Date | null>(null);
  ...
  return (
    <div className="">
      <div className="w-full max-w-9xl mx-auto p-3 sm:p-4">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-3 sm:p-4 mb-3">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-base sm:text-lg font-semibold text-gray-900">Detail Reports</h1>
                <p className="text-xs text-gray-600">Comprehensive financial and transaction reports</p>
              </div>
            </div>

            <button
              onClick={() => router.push('/dashboard?tab=dashboard')}
              className="inline-flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-200 border border-gray-200"
            >
          ...
          <div className="mb-2">
            <div className="flex flex-wrap gap-1.5">
              {tabs.map((tab) => (
                <button
                  key={tab.id}
                  className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-medium transition-all duration-200 ${activeTab === tab.id
                    ? 'text-white shadow-sm'
                    : 'bg-gray-100 text-gray-600 hover:bg-gray-200 hover:text-gray-800 border border-gray-200'
                    }`}
                  style={activeTab === tab.id ? { background: `linear-gradient(135deg, #8B5CF6 0%, #7C3AED 100%)` } : {}}
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-2.5 pt-2.5 border-t border-gray-200">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-end gap-2">
              <div className="min-w-[120px] sm:min-w-[140px]">
                ...
                <select
                  ...
                  className="w-full px-2 py-1.5 text-xs border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none bg-white shadow-sm"
                >
              ...
              {/* Custom Date Range Selection (manual start & end dates) */}
              ...
              {getCurrentDateFilter() !== 'today' && (
                <div className="flex flex-col justify-end">
                  <div className="h-4"></div> {/* Spacer to align with input fields */}
                  <button
                    onClick={() => {
                    ...
                    className="flex items-center gap-1 px-2 py-1.5 text-xs font-medium text-red-600 hover:text-red-800 transition-colors bg-red-50 border border-red-200 rounded-lg hover:bg-red-100 h-[32px]"
            ...
            {activeTab !== 'bill-report' && (
              <div className="flex flex-col justify-end">
                ...
                <div className="flex items-center gap-2">
                  <button
                    onClick={handlePrint}
                    className="flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-medium text-gray-700 bg-gray-100 border border-gray-200 rounded-lg hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-200 h-[32px]"
                  >
                    <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-medium text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-200 shadow-sm h-[32px]"
