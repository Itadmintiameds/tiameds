...
const CompletedTable: React.FC<CompletedTableProps> = ({ 
  ...
  // The backend returns "Collected" + "Completed" visits combined and doesn't accept a
  // search param yet, so the "at least one completed test" filter and search/sort below
  // only apply to the current page, not the whole date range.
  ...
  // Search and sort only apply to the current page - see the note on fetchVisits above
  useEffect(() => {
