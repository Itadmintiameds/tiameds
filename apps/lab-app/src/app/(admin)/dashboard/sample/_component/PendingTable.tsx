...
//  UI without api integration dated 19.06.2026 16.20 pm............. 
...
//   const [searchTerm, setSearchTerm] = useState("");
//   const [expandedRow, setExpandedRow] = useState<Patient | null>(null);
...
//   const handleDropdownToggle = (row: Patient) => {
//   setExpandedRow((prev) =>
...
//       render: (row: Patient) => (
//         <div>
//           <p className="font-semibold text-p3 text-pneutral-900">{row.id}</p>
//           <p className="text-[12px] leading-[16px] font-normal text-pneutral-500">
//             {row.date}
//           </p>
//         </div>
...
//       accessor: "title",
//       render: (row: Patient) => {
//         const isSingleTest = row.itemType === "test" && row.items.length === 1;
//         const isOpen = expandedRow?.id === row.id;
...
//         <span className="font-semibold text-label-l4">
//           {row.itemType === "package"
//             ? row.title
//             : `${row.items.length} Tests`}
//         </span>
//       </div>
...
//     {isOpen && (
//       <div className="mt-2 w-full rounded-xl border border-secondary-200 bg-pneutral-50 p-4">
//         <div className="space-y-4">
...
//       accessor: "actions",
//       render: () => (
//         <button className="flex items-center gap-1 rounded-lg border border-success-900 px-4 py-1 text-label-l2 font-medium text-success-900 hover:bg-success-50 transition-colors">
//           <Plus size={12} strokeWidth={4} />
//           <span>Add Sample</span>
//         </button>
//       ),
...
//               value={searchTerm}
//               onChange={(e) => setSearchTerm(e.target.value)}
//               className="h-10 w-full rounded-lg border border-pneutral-200 pl-10 pr-4 text-sm outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500"
//             />
//           </div>
//           <div className="flex flex-wrap items-center gap-4">
//             <div className="flex items-center gap-2">
//               <span className="text-sm text-gray-500">Date Range:</span>
//               <select className="h-10 rounded-md border border-gray-200 px-3 text-sm focus:border-primary-500 focus:ring-1 focus:ring-primary-500">
...
//       {/* Table */}
//       <div className="mt-5 relative">
//         <NewCommonTable columns={columns} data={filteredPatients} pageSize={10} />
//       </div>
//     </div>
//   );
// };
...
// New UI without Api Intergation
