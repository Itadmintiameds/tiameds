...
const TestReferenceDocumentation = () => {
  ...
  return (
    <div className="w-full p-4 bg-info-50">
      ...
      <div className="mb-6">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-full bg-info-50 flex items-center justify-center">
              <FaBook className="text-2xl text-info-600" />
            </div>
            <div>
              <h1 className="text-h3 font-semibold text-pneutral-900">Test Reference System Documentation</h1>
              <p className="text-p3 text-pneutral-500">Complete guide to managing test reference ranges</p>
            </div>
          </div>
          <button
            onClick={() => router.back()}
            className="flex items-center gap-2 rounded-full border border-pneutral-200 bg-white px-4 py-2 text-p3 font-medium text-pneutral-700 hover:bg-pneutral-50 transition-colors"
          >
      ...
      {/* Table of Contents */}
      <div className="mb-6 rounded-xl bg-white border border-info-200 p-6"> 
        <h2 className="text-h6 font-semibold text-info-900 mb-4 flex items-center gap-2">
          <FaInfoCircle className="text-info-600" />
          Table of Contents
        </h2>
        <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 text-info-800">
          <li><a href="#overview" className="hover:text-info-600 hover:underline transition-colors">1. Overview</a></li>
          <li><a href="#adding-references" className="hover:text-info-600 hover:underline transition-colors">2. Adding References</a></li>
          <li><a href="#editing-references" className="hover:text-info-600 hover:underline transition-colors">3. Editing References</a></li>
          <li><a href="#updating-references" className="hover:text-info-600 hover:underline transition-colors">4. Updating References</a></li>
          <li><a href="#special-types" className="hover:text-info-600 hover:underline transition-colors">5. Special Test Descriptions</a></li>
          <li><a href="#report-json" className="hover:text-info-600 hover:underline transition-colors">6. Report JSON Structure</a></li>
          <li><a href="#reference-ranges" className="hover:text-info-600 hover:underline transition-colors">7. Reference Ranges</a></li>
          <li><a href="#validation" className="hover:text-info-600 hover:underline transition-colors">8. Validation Rules</a></li>
          <li><a href="#workflows" className="hover:text-info-600 hover:underline transition-colors">9. Common Workflows</a></li>
        </ul>
      </div>
      ...
      <div className="space-y-6">
        {/* Overview */}
        <section id="overview" className="rounded-xl bg-white border border-pneutral-200 p-6">
          <h2 className="text-h5 font-semibold text-pneutral-900 mb-4">Overview</h2>
          ...
          <div className="rounded-lg bg-success-50 border border-success-200 p-4">
            <h3 className="font-semibold text-success-900 text-p3 mb-2">Key Features:</h3>
            <ul className="list-disc list-inside space-y-1 text-success-800 text-p3">
        ...
        {/* Adding References */}
        <section id="adding-references" className="rounded-xl bg-white border border-pneutral-200 p-6">
          <h2 className="text-h5 font-semibold text-pneutral-900 mb-4">Adding References</h2>
          
          <div className="space-y-4">
            <div className="rounded-lg bg-secondary-50 border border-secondary-200 p-4">
              <h3 className="font-semibold text-secondary-900 text-p3 mb-2">Method 1: Add New Reference</h3>
              <ol className="list-decimal list-inside space-y-2 text-secondary-800 text-p3">
            ...
            <div className="rounded-lg bg-info-50 border border-info-200 p-4">
              <h3 className="font-semibold text-info-900 text-p3 mb-2">Method 2: Add Existing Test Reference</h3>
              <ol className="list-decimal list-inside space-y-2 text-info-800 text-p3">
              ...
              <p className="text-info-700 mt-3 text-p3">
                <FaCheckCircle className="inline mr-2 text-info-600" />
        ...
        {/* Editing References */}
        <section id="editing-references" className="rounded-xl bg-white border border-pneutral-200 p-6">
          <h2 className="text-h5 font-semibold text-pneutral-900 mb-4">Editing References</h2>
          <div className="rounded-lg bg-warning-50 border border-warning-200 p-4">
            <h3 className="font-semibold text-warning-900 text-p3 mb-2">Edit Process:</h3>
            <ol className="list-decimal list-inside space-y-2 text-warning-800 text-p3">
          ...
          <div className="mt-4 rounded-lg bg-danger-50 border border-danger-200 p-4">
            <FaExclamationTriangle className="inline text-danger-600 mr-2" />
            <span className="text-danger-800 text-p3">
        ...
        {/* Updating References */}
        <section id="updating-references" className="rounded-xl bg-white border border-pneutral-200 p-6">
          <h2 className="text-h5 font-semibold text-pneutral-900 mb-4">Updating References</h2>
          <p className="text-p3 text-pneutral-700 mb-4">
            The update process is the same as editing. When you click &quot;Save&quot; in the edit modal, the system:
          </p>
          <ol className="list-decimal list-inside space-y-2 text-p3 text-pneutral-700">
        ...
        <section id="special-types" className="rounded-xl bg-white border border-pneutral-200 p-6">
          <h2 className="text-h5 font-semibold text-pneutral-900 mb-4">Special Test Descriptions</h2>
          <p className="text-p3 text-pneutral-700 mb-4">
            These test descriptions have special validation and UI behavior:
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div className="rounded-lg bg-pneutral-50 border border-pneutral-200 p-3">
              <ul className="space-y-1 text-p3 text-pneutral-700">
                <li>• DESCRIPTION</li>
                <li>• DROPDOWN</li>
          ...
          <div className="rounded-lg bg-danger-50 border border-danger-200 p-4">
            <h3 className="font-semibold text-danger-900 text-p3 mb-2">Special Behavior Rules:</h3>
            <div className="space-y-2 text-danger-800 text-p3">
        ...
        <section id="report-json" className="rounded-xl bg-white border border-pneutral-200 p-6">
          <h2 className="text-h5 font-semibold text-pneutral-900 mb-4">Report JSON Structure</h2>
          <p className="text-p3 text-pneutral-700 mb-4">
            For <strong>&quot;DETAILED REPORT&quot;</strong> type, the <code className="bg-pneutral-100 px-2 py-1 rounded text-p2 text-pneutral-800">reportJson</code> field stores a structured JSON object:
          </p>
          <div className="bg-pneutral-900 text-success-400 p-4 rounded-lg overflow-x-auto">
            <pre className="text-p2">
{`{
  ...
  "followUp": "Follow-up instructions"
          ...
          <div className="mt-4 rounded-lg bg-info-50 border border-info-200 p-4">
            <p className="text-info-800 text-p3">
              <FaInfoCircle className="inline mr-2 text-info-600" />
        ...
        {/* Reference Ranges */}
        <section id="reference-ranges" className="rounded-xl bg-white border border-pneutral-200 p-6">
          <h2 className="text-h5 font-semibold text-pneutral-900 mb-4">Reference Ranges</h2>
          <p className="text-p3 text-pneutral-700 mb-4">
            Reference ranges are stored as a JSON array. Each range can specify:
          </p>
          <ul className="list-disc list-inside space-y-1 text-p3 text-pneutral-700 mb-4">
            <li>Gender (M, F, or MF)</li>
            <li>Age range (min/max with units)</li>
            <li>Reference range value</li>
          </ul>
          <div className="rounded-lg bg-success-50 border border-success-200 p-4">
            <h3 className="font-semibold text-success-900 text-p3 mb-2">Using the Reference Ranges Builder:</h3>
            <ol className="list-decimal list-inside space-y-2 text-success-800 text-p3">
        ...
        {/* Validation Rules */}
        <section id="validation" className="rounded-xl bg-white border border-pneutral-200 p-6">
          <h2 className="text-h5 font-semibold text-pneutral-900 mb-4">Validation Rules</h2>
          <div className="space-y-4">
            <div className="rounded-lg bg-pneutral-50 border border-pneutral-200 p-4">
              <h3 className="font-semibold text-pneutral-900 text-p3 mb-2">Required Fields (All Types):</h3>
              <ul className="list-disc list-inside space-y-1 text-p3 text-pneutral-700">
            ...
            <div className="rounded-lg bg-pneutral-50 border border-pneutral-200 p-4">
              <h3 className="font-semibold text-pneutral-900 text-p3 mb-2">Conditional Requirements:</h3>
              <ul className="list-disc list-inside space-y-1 text-p3 text-pneutral-700">
            ...
            <div className="rounded-lg bg-pneutral-50 border border-pneutral-200 p-4">
              <h3 className="font-semibold text-pneutral-900 text-p3 mb-2">Validation Rules:</h3>
              <ul className="list-disc list-inside space-y-1 text-p3 text-pneutral-700">
        ...
        {/* Common Workflows */}
        <section id="workflows" className="rounded-xl bg-white border border-pneutral-200 p-6">
          <h2 className="text-h5 font-semibold text-pneutral-900 mb-4">Common Workflows</h2>
          <div className="space-y-4">
            <div className="rounded-lg bg-secondary-50 border border-secondary-200 p-4">
              <h3 className="font-semibold text-secondary-900 text-p3 mb-2">Workflow 1: Add New Test Reference</h3>
              <ol className="list-decimal list-inside space-y-1 text-secondary-800 text-p3">
            ...
            <div className="rounded-lg bg-info-50 border border-info-200 p-4">
              <h3 className="font-semibold text-info-900 text-p3 mb-2">Workflow 2: Edit Existing Reference</h3>
              <ol className="list-decimal list-inside space-y-1 text-info-800 text-p3">
            ...
            <div className="rounded-lg bg-success-50 border border-success-200 p-4">
              <h3 className="font-semibold text-success-900 text-p3 mb-2">Workflow 3: Add Multiple References to Same Test</h3>
              <ol className="list-decimal list-inside space-y-1 text-success-800 text-p3">
        ...
        {/* Tips Section */}
        <section className="rounded-xl bg-white border border-info-200 p-6">
          <h2 className="text-h5 font-semibold text-pneutral-900 mb-4">Tips & Best Practices</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="rounded-lg bg-pneutral-100 border border-info-200 p-4">
              <h3 className="font-semibold text-info-900 text-p3 mb-2">For Users:</h3>
              <ul className="list-disc list-inside space-y-1 text-info-900 text-p3">
            ...
            <div className="rounded-lg bg-pneutral-100 border border-secondary-200 p-4">
              <h3 className="font-semibold text-secondary-900 text-p3 mb-2">Technical Notes:</h3>
              <ul className="list-disc list-inside space-y-1 text-secondary-900 text-p3">
      ...
      {/* Footer */}
      <div className="mt-8 rounded-xl bg-white border border-pneutral-200 p-6 text-center">
        <p className="text-p3 text-pneutral-600">
          For additional support or questions, please contact your system administrator.
        </p>
        <button
          onClick={() => router.back()}
          className="mt-4 px-6 py-2 text-p3 font-medium text-pneutral-50 bg-secondary-700 rounded-full hover:bg-secondary-800 transition-colors flex items-center gap-2 mx-auto"
        >
          <FaArrowLeft className="h-4 w-4" />
