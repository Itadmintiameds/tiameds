    ...
    return (
        <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div className="mb-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                <h2 className="text-lg font-semibold text-gray-900">Active Lab Members</h2>
                {currentLab && (
            ...
            {loading ? (
                ...
                <div className="text-center py-8">
                    ...
                    <h3 className="text-base font-semibold text-gray-800 mb-1">No active members found</h3>
                    <p className="text-sm text-gray-600">
                        There are currently no active members assigned to this lab.
                    </p>
                </div>
            )}
        </section>
