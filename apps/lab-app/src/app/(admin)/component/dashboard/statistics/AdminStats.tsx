...
// const COLLECTION_COLORS = ["#6C63FF", "#39C0C8", "#6BD3A7", "#FF5A5F"];
...
//             <div
//               key={item.title}
//               className="rounded-xl border border-pneutral-100 bg-white p-5 shadow-xsm"
//             >
//               <div className="flex items-start gap-4">
//                 <div
//                   className={`flex h-11 w-11 items-center justify-center rounded-full ${item.iconBg}`}
...
//                     {item.title}
//                   </h4>
//                   <h2 className="mt-1 text-[34px] font-semibold leading-none text-pneutral-900">
//                     {item.value}
//                   </h2>
//                   {item.trend && (
//                     <div
...
//                 {item.title}
//               </h4>
//               <h2 className="mt-5 text-[38px] font-semibold text-pneutral-900">
//                 {item.value}
//               </h2>
//             </div>
//           ))}
...
//                   // Colors for each funnel section
//                   const colors = ["#4F11B8", "#FDBA12", "#5470F5", "#EF5A5A", "#52C41A"];
//                   const widths = [170, 140, 100, 80, 60];
                  
//                   return scaledHeights.map((height, index) => {
//                     const y = scaledYPositions[index];
//                     const width = widths[index] || 60;
//                     const x = (230 - width) / 2;
//                     const nextWidth = widths[index + 1] || 60;
//                     const nextX = (230 - nextWidth) / 2;
                    
//                     // For the last section, use a flat bottom
//                     if (index === scaledHeights.length - 1) {
//                       return (
//                         <rect
//                           key={index}
//                           x={x}
...
//                     // For other sections, use trapezoid
//                     const nextY = scaledYPositions[index + 1];
//                     const nextHeight = scaledHeights[index + 1];
...
//       <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
//         {/* Revenue by Collection Method */}
//         <div className="rounded-3xl border border-pneutral-200 bg-white p-6 shadow-sm">
//           <div className="flex items-center justify-between mb-8">
//             <h2 className="text-2xl font-semibold text-pneutral-800">
//               Revenue by Collection Method
//             </h2>
//             {renderFilterDropdown(
//               collectionFilter,
...
//             {/* Gender Section */}
//             <div>
//               <h3 className="mb-5 text-lg font-semibold text-pneutral-700">
//                 Gender
//               </h3>
...
//                         </span>
//                       </div>
//                       <span className="text-lg font-semibold text-pneutral-700">
//                         {item.value}%
//                       </span>
//                     </div>
//                   ))}
