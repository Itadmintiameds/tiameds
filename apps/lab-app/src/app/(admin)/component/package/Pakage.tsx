...
//               className="w-full border rounded p-2 text-sm focus:ring-2 focus:ring-blue-400"
//             />
//             <BsCurrencyRupee className="absolute top-1/2 transform -translate-y-1/2 right-2 text-gray-400" />
//           </div>
//         </div>
//       </div>
  ...
  return (
    <div className="p-6 bg-gray-50 rounded-lg shadow-md max-w-full mx-auto">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500 flex gap-2">
                        ...
                        <span className="flex items-center gap-1 text-green-600 font-medium">
                          <BsCurrencyRupee className="text-xs" /> {test.price}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <AnimatePresence>
                  {selectedTests.map((test) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        <span className="text-sm font-medium text-gray-700">₹{test.price}</span>
                        <button
                          onClick={() => handleRemoveTest(test.id)}
      ...
      >
        <button
          onClick={handleSubmit}
          disabled={!packageData.packageName || selectedTests.length === 0 || loading}
          className={`w-full px-6 py-3 rounded-lg text-white font-medium shadow-md transition-all flex items-center justify-center gap-2
            ${(!packageData.packageName || selectedTests.length === 0)
