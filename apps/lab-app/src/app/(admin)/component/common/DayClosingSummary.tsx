        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          {loading ? (
            <div className="flex justify-center items-center py-8">
              ...
              <span className="ml-2 text-gray-600">Loading bill counts...</span>
            </div>
          ) : (
            ...
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              <div className="text-center">
                <p className="text-sm font-medium text-gray-600 mb-2">Total Bills</p>
                  <p className="text-2xl font-bold text-gray-900">{finalBillCountData.totalBills}</p>
              </div>
            </div>
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              <div className="text-center">
                <p className="text-sm font-medium text-gray-600 mb-2">Cash Bills</p>
                  <p className="text-2xl font-bold text-gray-900">{finalBillCountData.cashBills}</p>
              </div>
            </div>
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              <div className="text-center">
                <p className="text-sm font-medium text-gray-600 mb-2">Credit Bills</p>
                  <p className="text-2xl font-bold text-gray-900">{finalBillCountData.creditBills}</p>
              </div>
            </div>
          </div>
          )}
