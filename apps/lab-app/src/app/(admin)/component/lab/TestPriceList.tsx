...
import { FaDownload, FaFileExcel, FaFilter, FaSearch, FaTimes } from 'react-icons/fa';
...
export const TestPriceList = () => {
  ...
  const handleDownloadCsv = async () => {
    try {
      ...
      saveAs(blob, 'test_price_list.csv');
  ...
  const handleDownloadExcel = async () => {
    try {
      ...
      XLSX.writeFile(workbook, 'test_price_list.xlsx');
