  ...
  return (
    <div className="min-h-screen bg-secondary-50">
      ...
      >
        {viewLabDetails ? (
          <div className="space-y-3">
            <div className="flex items-center justify-between rounded-xl border border-gray-200 bg-gradient-to-r from-gray-50 to-white p-2 shadow-sm">
      ...
      {loading ? (
        ...
        <div className="flex items-center justify-center rounded-xl border border-pneutral-200 bg-white py-16 text-sm text-pneutral-500">
          No labs available.
        </div>
      ) : (
        <NewCommonTable
