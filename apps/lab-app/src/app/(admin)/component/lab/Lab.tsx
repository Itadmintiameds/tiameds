...
const Lab = () => {
  ...
  const renderPreview = () => (
    <div className={`bg-white h-full flex flex-col transition-all duration-300 ${isPreviewCollapsed ? 'w-16' : 'w-1/2'}`}>
      <div 
        className="px-4 py-3 flex justify-between items-center relative overflow-hidden bg-secondary-500"
      >
        {!isPreviewCollapsed && (
      ...
      {!isPreviewCollapsed && (
        <div className="p-4 overflow-y-auto flex-1">
          <div className="space-y-3">
            {/* Lab Header Card */}
            <div 
              className="p-4 shadow-sm bg-secondary-500"
            >
        ...
        <div className={`flex-1 transition-all duration-300 ${isPreviewCollapsed ? 'w-full' : 'w-1/2'}`}>
          <div className="max-w-3xl mx-auto">
            <div className="bg-white shadow-xl overflow-hidden">
              {/* Header */}
              <div 
                className="px-6 py-3 relative overflow-hidden bg-secondary-600"
              >
