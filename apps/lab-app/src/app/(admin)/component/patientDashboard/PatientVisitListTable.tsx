// import { getAllVisits,getAllPatientVisitsByDateRange } from '@/../services/patientServices';
...
//           // const response = await getAllPatientVisitsByDateRange(
//           //   currentLab.id,
//           //   customStartDate || '',
//           //   customEndDate || ''
//           // );
...
// import { getAllPatientVisitsByDateRange } from '@/../services/patientServices';
// import { useLabs } from '@/context/LabContext';
// import { Patient } from '@/types/patient/patient';
// import { PlusIcon } from 'lucide-react';
// import React, { useEffect, useState } from 'react';
...
//           // The API response has a "data" array containing the patient visits
//           setPatientList(response?.data || []);
//         }
//       } catch (error: unknown) {
//         toast.error((error as Error).message || 'An error occurred while fetching visits', {
