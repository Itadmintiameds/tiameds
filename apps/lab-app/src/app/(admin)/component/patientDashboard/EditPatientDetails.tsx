...
//     const globalDiscountPercent = parseFloat(editedPatient.visit?.billing.discountPercentage?.toString() || '0') || 0;
...
//     };
//   }, [selectedTests, selectedPackages, editedPatient.visit?.billing.discountPercentage]);
...
//       if (
//         prev.visit.billing.totalAmount === totalAmount &&
//         prev.visit.billing.netAmount === netAmount &&
//         prev.visit.billing.discount === globalDiscountAmount &&
//         prev.visit.billing.discountPercentage === globalDiscountPercent
//       ) {
//         return prev;
//       }
...
//     const globalDiscountPercent = parseFloat(editedPatient.visit?.billing.discountPercentage?.toString() || '0') || 0;
//     const globalDiscountAmount = parseFloat(((totalAfterTestDiscounts * globalDiscountPercent) / 100).toFixed(2));
//     const amountAfterGlobalDiscount = parseFloat((totalAfterTestDiscounts - globalDiscountAmount).toFixed(2));
//     const netAmount = amountAfterGlobalDiscount;
