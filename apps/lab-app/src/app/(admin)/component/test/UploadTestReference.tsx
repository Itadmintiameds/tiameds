        ...
        {totalReferences > 0 ? (
          <>
            ...
            <p className="text-p3 text-pneutral-700 mb-4">
              You have reference ranges configured for <span className="font-semibold text-pneutral-900">{totalReferences}</span> test(s).
            </p>
          ...
          <>
            ...
            <p className="text-p3 text-pneutral-500 mb-6">
              Select a file to upload and start your test process. Accepted formats: <span className="font-medium text-pneutral-700">.csv</span>
            </p>
