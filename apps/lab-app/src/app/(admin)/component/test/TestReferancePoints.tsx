...
//     // Calculate stats before grouping
//     const stats = {
...
//     try {
//       setLoading(true);
//       console.log("Updating test reference range:", formData);
//       // Validate form data
...
//   function handleEditRecord(test: TestReferancePoint): void {
//     setEditRecord(test);
//     setFormData(test);
...
//   // Add existing reference record handler
//   async function handleAddExistingReferanceRecord(e: React.FormEvent) {
//     e.preventDefault();
...
const TestReferancePoints = () => {
  ...
  async function handleUpdate(e: React.FormEvent) {
    ...
    try {
      ...
      const payload = {
        ...formData,
        minReferenceRange: Number(formData.minReferenceRange),
        maxReferenceRange: Number(formData.maxReferenceRange),
      ...
      setReferencePoints(prevPoints =>
        prevPoints.map((item) =>
          item.id === editRecord.id ? { ...item, ...payload } : item
        )
      );
      toast.success("Test reference range updated successfully.");
      setEditModalOpen(false);
