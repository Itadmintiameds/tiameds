...
export const TestLists = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      modalClassName='max-w-sm'
        >
        <AddTest closeModal={() => setModalOpen(false)} />
      </Modal>
      ...
      {loading ? (
        ...
        <>
          ...
          <TableComponent
            data={currentTests}
            columns={[
              { header: "#", accessor: (test) => currentTests.indexOf(test) + 1 },
              ...
              // { header: "Updated At", accessor: (test) => test.updatedAt },
              {
                ...
                accessor: (test) => (
                  <div className="flex justify-around">
                    ...
                    <MdModeEditOutline className="text-indigo-500 text-xl cursor-pointer" />
                  </div>
                ),
              },
            ]}
