...
export default function KeyFeaturesSection() {
  return (
    <section className="bg-base-white py-20 sm:py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl font-bold text-pneutral-900 sm:text-4xl mb-4 font-heading">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="bg-pneutral-50 p-6 rounded-lg border border-pneutral-100 hover:border-primary-200 transition-all duration-300 hover:shadow-lg h-full flex flex-col">
                {/* Icon */}
                <div className="w-12 h-12 rounded-full bg-primary-100 text-primary-700 flex items-center justify-center mb-4 transition-all duration-300 group-hover:bg-primary-700 group-hover:text-base-white">
                  {feature.icon}
                </div>

                {/* Content */}
                <h3 className="text-h6 font-semibold text-pneutral-900 mb-2 font-heading">
                  {feature.title}
                </h3>
                <p className="text-p3 text-pneutral-600 flex-grow">
                  {feature.description}
                </p>
