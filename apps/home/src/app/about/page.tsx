...
const AboutPage = () => {
  ...
  return (
    <div className="bg-white">
      <main className="isolate space-y-32 md:space-y-40">
        {/* Hero section */}
        <section className="relative overflow-hidden bg-gradient-to-b from-gray-50 to-white pt-24 pb-20 sm:pt-32 sm:pb-28">
            ...
            <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {services.map((service, index) => (
                <motion.div
                  ...
                  className="flex flex-col rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-900/10 hover:shadow-md transition-all"
                >
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <motion.p
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6, delay: 0.1 }}
                className="mx-auto mt-4 max-w-xl text-lg leading-8 text-white/90"
              >
