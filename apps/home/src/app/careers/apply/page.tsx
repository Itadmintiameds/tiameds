...
const ApplyPage: React.FC = () => {
  ...
  const jobsPerPage: number = 2
  const totalPages: number = Math.ceil(jobListings.length / jobsPerPage)

  const indexOfLastJob: number = currentPage * jobsPerPage
  const indexOfFirstJob: number = indexOfLastJob - jobsPerPage
  const currentJobs: Job[] = jobListings.slice(indexOfFirstJob, indexOfLastJob)
  ...
  return (
    <div className="bg-white">
      <div className="relative px-6 pt-14 lg:px-8">
        <div className="text-center">
          <h1 className="text-5xl font-semibold text-gray-900">Explore Open Positions</h1>
        ...
        {showModal && selectedJob && (
          <div className="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-75 z-50">
            <div className="bg-white rounded-lg p-8 shadow-lg relative w-3/4">
              <button
                onClick={handleCloseModal}
